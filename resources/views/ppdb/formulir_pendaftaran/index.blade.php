...
<script>
    ...
    $('#submitForm').click(function(e) {
        ...
        $('#create_nisn, #create_jenis_kelamin,#create_asal_sekolah,#create_alamat,#create_nama_siswa,#create_tgl_lahir,#create_no_hp_orang_tua,#create_sekolah,#create_jurusan ').removeClass('is-invalid');

        // Validasi input
        var errors = false;
        $('#create_nisn, #create_jenis_kelamin,#create_asal_sekolah,#create_alamat,#create_nama_siswa,#create_tgl_lahir,#create_no_hp_orang_tua,#create_sekolah,#create_jurusan ').each(function() {
    ...
    $('#show-formulir').click(function() {
        $('#create_nisn, #create_jenis_kelamin,#create_asal_sekolah,#create_alamat,#create_nama_siswa,#create_tgl_lahir,#create_no_hp_orang_tua,#create_sekolah,#create_jurusan ').removeClass('is-invalid');
        $('#create_nisn, #create_jenis_kelamin,#create_asal_sekolah,#create_alamat,#create_nama_siswa,#create_tgl_lahir,#create_no_hp_orang_tua,#create_sekolah,#create_jurusan ').val('');
    });
